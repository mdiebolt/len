window.lenses = [
  ...
  Surprise is a crucial part of all entertainment — it is at the root of humor, strategy, and problem solving. Our brains are hardwired to enjoy surprises. In an experiment where participants received sprays of sugar water or plain water into their mouths, the participants who received random sprays consid- ered the experience much more pleasurable than participants who received the sprays according to a fixed pattern, even though the same amount of sugar was delivered. In other experiments, brain scans revealed that even during unpleasant surprises, the pleasure centers of the brain are triggered.
  """
  """
  ...
  In some situations, there may be still more filters; for example, an educa- tional game will also have to answer questions like “Does this game teach what it is supposed to?” If your design requires more filters, don’t neglect them.
  """
  """
  ...
  - Is there some other method I can use to coerce players toward ideal behav- ior without impinging on their feeling of freedom?
  """
  """
  ...
  - This lens is important and overdue. It works very well in combination with other lenses, such as Lens #63: The Lens of Beauty and Lens #80: The Lens of Status.
  """
  """
